...
/***/ "./node_modules/hqy-lazyload/dist/hqy-lazyload.js":
/*!********************************************************!*\
  !*** ./node_modules/hqy-lazyload/dist/hqy-lazyload.js ***!
  \********************************************************/
...
!function () {
  ...
  __namespace__('./index.js', function (__include__, exports, module) {
    ...
    var saveViewportOffset = function saveViewportOffset(viewport, offset) {
  ...
  __namespace__('./loadElement.js', function (__include__, exports, module) {
    ...
    function process(el, dataSrc, options, context) {
      ...
      var onSuccessHandler = function onSuccessHandler() {
        // Is element an image
        if (isImage) {
          if (!isPicture) {
    ...
    module.exports = {
      ...
      loadElement: function loadElement(el, force) {
        var options = this.options;
        var context = this.context;
        var that = this; // if element is visible, not loaded or forced
  ...
  if (true) {
    ...
    !(__WEBPACK_AMD_DEFINE_FACTORY__ = (__include__('./index.js')),
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).foundation(); //slick slider
...
__webpack_require__(/*! hqy-lazyload */ "./node_modules/hqy-lazyload/dist/hqy-lazyload.js");
...
module.exports = __webpack_require__(/*! /Applications/MAMP/htdocs/hirani/hira-ni.co.uk/src/assets/js/app.js */"./src/assets/js/app.js");
