...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
  var buttonclicked;
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.nav-menu').click(function () {
    if (buttonclicked != true) {
      buttonclicked = true;
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('#nav-icon1,#nav-icon2,#nav-icon3,#nav-icon4').toggleClass('open');
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('header nav').slideToggle();
    } else {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('#nav-icon1,#nav-icon2,#nav-icon3,#nav-icon4').toggleClass('open');
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('header nav').slideToggle();
    }
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).scroll(function () {
    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).scrollTop() > 100) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('header').addClass('fixed-header');
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('header .sub-header').slideUp();
    } else {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('header').removeClass('fixed-header');
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('header .sub-header').show();
    }
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.drop').click(function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.drop-down').slideToggle();
  });
});
AOS.init({
  offset: 120,
...
module.exports = __webpack_require__(/*! /Users/e16008107/Sites/safe-water/src/assets/js/app.js */"./src/assets/js/app.js");
